...
public class MajorityElement {
    ...
    public static int solution(int[] nums){
        return recursiveMajorityElement(nums, 0, nums.length-1);
    }
     ...
     */
    public static int recursiveMajorityElement(int[] nums, int start, int end){
        ...
        int mid = (start + end)/2;
        int leftMajority = recursiveMajorityElement(nums, start, mid);
        int rightMajority = recursiveMajorityElement(nums, mid+1, end);
