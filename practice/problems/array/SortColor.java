...
/*
    ...
    > idea: In more than one pass the problem is trivial, simply use the strategy
    of the counting sort and fill the array. The tricky part is to solve the problem
    with one pass. 
    The intuition is pretty easy: you store the index of where to put the zeroes that
    starts from zero and you store the index where to put twos. 
