...
/*
    ...
    intervals that cover all the intervals in the result

    > idea: We sort the input by the start of the intervals, then 
    we insert the first interval in an array and, starting with the second 
    interval, if there is no overlap we insert, otherwise we merge and than insert
*/
