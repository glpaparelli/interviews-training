...
public class SoAT {
    ...
    public static boolean solution(TreeNode root, TreeNode subRoot){
        ...
        // helper return true if root and subroot are identical
        if(helper(root, subRoot))
            return true;

        // for each subtree of the tree "root" we check if the tree "subroot" is equal to 
        // that subtree of the tree "root"
