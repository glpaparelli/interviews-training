 ...
 *   store the intervals that checkOverlap with newInterval and the result list, 
 *   where we store th list of intervals that do not checkOverlap with newInterval. 
...
public class InsertInterval {
    ...
    /**
     * @param intervals list of intervals that do not checkOverlap with newInterval
    ...
    private static Integer[][] insertInterval(List<Integer[]> intervals, Integer[] newInterval) {
        ...
        // corner case: every interval checkOverlap with newInterval, hence intervals is empty
    ...
    private static boolean checkOverlap(Integer[] a, Integer[] b) {
        if(a[0] <= b[1] && a[1] >= b[0])
            return true;
